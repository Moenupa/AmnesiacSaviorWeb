<template>
	<div id="todo-list" v-cloak>
		<div id="calendar">
      <date-picker v-model="targetdate" placeholder="Select Date"></date-picker>
    </div>
		<div id="todo-header">
			<time>
				<b>{{ days[targetdate.getDay()] }},</b>
				{{ targetdate.getDate() }}{{ getAppendix() }}
				<br />
...
export default {
  components: { DatePicker },
    ...
    getAppendix: function() {
      switch (this.targetdate.getDate()) {
			case 1:
			case 21:
				return "st";
			case 2:
    ...
    taskIsTargetDate: function(task) {
      return this.targetdate === task
    }
	},
	created() {
	}
